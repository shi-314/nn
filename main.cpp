...
#define NUM_HL_NEURONS 2

int main() {
	srand(time(0));

	NeuralNet net;
	net.setNumInputs(NUM_INPUTS);
	net.setNumOutputs(NUM_OUTPUTS);
	net.setNumHiddenLayers(NUM_HIDDEN_LAYERS);
	net.setNumNeuronsPerHL(NUM_HL_NEURONS);
